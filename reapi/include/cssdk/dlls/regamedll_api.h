...
typedef IHookChainClass<void, class CBasePlayer> IReGameHook_CBasePlayer_DropIdlePlayer;
typedef IHookChainRegistryClass<void, class CBasePlayer> IReGameHookRegistry_CBasePlayer_DropIdlePlayer;
